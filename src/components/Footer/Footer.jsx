...
export default function Footer(){
    return (
        <footer className="footer">
            <img src={loopStudiosLogo} alt="Loopstudios Logo" className="footer__logo" />
            ...
            <div className="footer__socials">
                ...
                <img src={pinterestIcon} alt="Pinterest Icon" className="footer__social-icon" />
                <img src={instagramIcon} alt="Instagram Icon" className="footer__social-icon" />
            </div>
